...
export const CONDITIONS: ConditionData[] = [
  ...
  },
  {
    ...
    audience: "all",
    shortDescription: "Sexual and intimate health concerns in men and women — evaluated medically, in private.",
    hook: "Many people carry this in silence for years. The silence is the worst part.",
    reflectiveClose: "There's no version of waiting that helps.",
    heroSubline:
      "Concerns like low desire, erectile difficulty, premature ejaculation, painful sex, and vaginal dryness are often the first sign of a hormonal or metabolic story. A Kyros doctor evaluates the underlying cause — hormonal, vascular, psychological — and builds a clinical plan, for men and women alike.",
    symptoms: [
    ...
    whatWeOffer: [
      "Clinical evaluation of sexual and intimate health concerns in men and women",
      "Hormonal and metabolic workup where indicated (testosterone, prolactin, thyroid, glucose)",
      "Evidence-based management of erectile dysfunction, premature ejaculation, low libido, and intimate discomfort",
    ...
    stats: [
      { numeral: "Private", caption: "no condition names in any notification" },
      { numeral: "1 consultation", caption: "is all it takes to begin an honest evaluation" },
      { numeral: "Men & women", caption: "intimate health is for everyone, not just men" },
    ],
    faqs: [
      {
        question: "Is this only for men?",
        answer:
          "No. Sexual and intimate health concerns affect both men and women. Kyros evaluates erectile dysfunction, premature ejaculation, and low libido in men, and low libido, vaginal dryness, and painful sex in women — with the same private, doctor-led approach.",
      },
      {
      ...
      {
        question: "Are these concerns always psychological?",
        answer:
          "No. While stress, anxiety, and relationship factors can contribute, many intimate-health concerns have a hormonal, vascular, or metabolic component. A proper evaluation distinguishes between physical and psychological causes, which determines the most effective treatment.",
      },
    ],
    schemaName: "Sexual Health",
    schemaDescription:
      "Evaluation and management of sexual and intimate health concerns in men and women, including erectile dysfunction, premature ejaculation, low libido, vaginal dryness, and painful sex, often related to hormonal, vascular, or metabolic factors.",

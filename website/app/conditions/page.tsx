...
export const metadata: Metadata = {
  ...
  description:
    'Kyros Clinic covers eight chronic hormonal and metabolic conditions: thyroid, PCOS, weight management, skin & hair, sexual & intimate health, hormones & TRT, diabetes, and longevity.',
